...
<body class="index-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        <li>
          <a href="{{ url('/home') }}" class="{{ set_active('home')}} }}">
            <i class="bi bi-house-check-fill navicon"></i> Dashboard</a>
        </li>
        <li><a href="{{ route('profile.index') }}" class="{{ set_active('profile.index')}}"><i
              class="bi bi-file-earmark-text navicon"></i> Profile</a></li>
        <li>
          <a href="{{ route('banner.index') }}" class="{{ request()->routeIs('banner.*') ? 'active' : '' }}">
            <i class="bi bi-house navicon"></i>Banner
          </a>
        </li>
        <li><a href="{{ route('about.index') }}" class="{{ set_active('about.index')}}"><i
              class="bi bi-person navicon"></i> About</a></li>
